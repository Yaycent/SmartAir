...
/**
 * Handles the business logic for the user login process.
 * <p>
 * This class implements the Presenter layer of the MVP architecture.
 * It acts as an intermediary between the View (LoginActivity) and the Model (Firebase Auth/Firestore),
 * ensuring that the UI code remains clean and free of database logic.
 * </p>
 *
 * @author Judy Xu
 */
