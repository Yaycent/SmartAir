...
import com.example.smartair.utils.BadgeCallback;
import com.example.smartair.utils.BadgeLibrary;
import com.example.smartair.models.ControllerLog;
import com.example.smartair.utils.ParentAlertHelper;
import com.example.smartair.R;
import com.example.smartair.utils.RecordPEFFeature;
 ...
 * <p>
 * Acts as the main dashboard for Child users (Requirement R3, R4, R5).
 * </p>
 * <b>Key Functionalities:</b>
 * <ul>
 * <li><b>Medication Logging:</b> Logs usage of Rescue and Controller medications, updates inventory, and tracks adherence.</li>
 * <li><b>PEF Recording:</b> Navigates to the screen for recording Peak Expiratory Flow values.</li>
 * <li><b>Symptom Tracking:</b> Provides access to the Daily Check-in and Symptom logging features.</li>
 * <li><b>Emergency Support:</b> Includes an SOS button for immediate alerts and triage guidance.</li>
 * <li><b>Gamification:</b> Calculates and displays daily streaks for controller medication use and awards badges (e.g., First Perfect Controller Week).</li>
 * </ul>
 *
 * @author 	Jiayi Qi, Judy Xu, Rphael Wang, Tan Ngo, Zhan Tian
 * @version 5.0
 */
