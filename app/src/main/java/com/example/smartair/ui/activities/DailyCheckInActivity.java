 ...
 * <p>
 * Handles the recording of daily health status and symptoms (Requirement R5).
 * Allows the user (Child or Parent) to log specific asthma control indicators and environmental triggers.
 * </p>
 * <b>Key Functionalities:</b>
 * <ul>
 * <li><b>Symptom Logging:</b> Captures key control indicators: Night Waking, Activity Limitations, and Cough/Wheeze.</li>
 * <li><b>Trigger Tracking:</b> Allows selection of multiple triggers (e.g., Exercise, Cold Air, Smoke).</li>
 * <li><b>Author Attribution:</b> Distinguishes whether the entry was made by the Child or the Parent.</li>
 * <li>Saves the data to the Firestore "symptomLogs" collection for history tracking.</li>
 * </ul>
 *
 * @author Rphael Wang
 * @version 1.0
