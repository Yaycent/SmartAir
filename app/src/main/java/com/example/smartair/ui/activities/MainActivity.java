...
/**
 * MainActivity.java (Login View)
 * <p>
 * Serves as the primary Login screen for Parents and Providers (Requirement R1).
 * This class implements the <b>View</b> layer of the MVP architecture for the Login Module.
 * </p>
 * <b>Key Responsibilities:</b>
 * <ul>
 * <li>Captures user credentials (Email/Password) and forwards them to the {@link LoginPresenter}.</li>
 * <li>Handles UI state updates (Loading bars, Toast messages) driven by the Presenter.</li>
 * <li>Manages navigation to Registration, Onboarding, or specific Dashboards based on authentication success.</li>
 * <li>Provides "Forgot Password" functionality via Firebase Auth.</li>
 * </ul>
 *
