...
import com.example.smartair.ui.adapters.OnboardingAdapter;
import com.example.smartair.R;
import com.example.smartair.models.OnboardingPage;
/**
 * OnboardingActivity.java
 * <p>
 * Manages the onboarding experience for first-time users (Requirement R1).
 * Displays role-specific tutorial slides to explain app features and privacy settings.
 * </p>
 * <b>Key Functionalities:</b>
 * <ul>
 * <li><b>Dynamic Content:</b> Loads different onboarding pages based on the user role (Parent, Child, or Provider).</li>
 * <li><b>Navigation:</b> Provides "Next" and "Skip" functionality to navigate through the tutorial.</li>
 * <li><b>State Persistence:</b> Uses {@link SharedPreferences} to record that onboarding is complete, preventing it from showing again.</li>
 * <li><b>Role Routing:</b> Redirects the user to their specific Dashboard (Parent, Child, or Provider) upon completion.</li>
 * </ul>
 *
 * @author Zhan Tian
 * @version 1.0
