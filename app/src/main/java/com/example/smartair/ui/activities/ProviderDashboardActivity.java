 ...
 * <p>
 * Serves as the main dashboard for Healthcare Providers (Requirement R2, R6).
 * Enables providers to monitor their patients' asthma status based on shared permissions.
 * </p>
 * <b>Key Functionalities:</b>
 * <ul>
 * <li><b>Patient Linking:</b> Allows providers to link with parents using a secure invite code (R2).</li>
 * <li><b>Permission-Based Viewing:</b> dynamically shows/hides data sections (Meds, PEF, Symptoms) based on the Parent's sharing settings (R2 Granular Control).</li>
 * <li><b>Data Visualization:</b> Displays shared PEF trends and medication inventory levels.</li>
 * <li><b>Emergency Alerts:</b> Shows critical alerts (like Red Zone days) if the parent has enabled sharing for them.</li>
 * </ul>
 *
 * @author Judy Xu, Jiayi Qi
 * @version 3.0
 */
