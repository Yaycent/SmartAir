 ...
 * <p>
 * Handles the registration of new accounts for Parents and Healthcare Providers (Requirement R1).
 * </p>
 * <b>Key Functionalities:</b>
 * <ul>
 * <li><b>Account Creation:</b> Uses Firebase Authentication to create new users via Email/Password.</li>
 * <li><b>Input Validation:</b> Enforces rules for non-empty fields and minimum password length (R1 Validation).</li>
 * <li><b>Role Persistence:</b> Captures the selected role (passed via Intent) and saves it to the Firestore "users" collection.</li>
 * <li><b>Error Handling:</b> Provides feedback via Toasts for registration failures (e.g., existing email, weak password).</li>
 * </ul>
 *
 * @author Judy Xu, Jiayi Qi, Tan Ngo
 * @version 3.0
 */
