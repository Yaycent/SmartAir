 ...
 * <p>
 * Handles the second phase of the emergency triage flow (Requirement R4).
 * This activity guides the user through safety checks based on their PEF values and action plan.
 * </p>
 * <b>Key Functionalities:</b>
 * <ul>
 * <li><b>Zone Calculation:</b> Determines the user's asthma zone (Green/Yellow/Red) based on current PEF vs. Personal Best.</li>
 * <li><b>Action Plan Guidance:</b> Displays customized instructions (from Parent Settings) corresponding to the calculated zone.</li>
 * <li><b>Safety Timer:</b> Initiates a 10-minute countdown for Yellow/Red zones to reassess the child's condition.</li>
 * <li><b>Escalation Logic:</b> Triggers immediate parent alerts and prompts to call 911 if the condition worsens or remains critical.</li>
 * </ul>
 *
 * @author Zhan Tian, Judy Xu
 * @version 2.0
 */
