 ...
 * <p>
 * Handles the initial phase of the "One-Tap Triage" process (Requirement R4).
 * Presents a quick checklist of critical "Red Flag" symptoms to the user.
 * </p>
 * <b>Key Functionalities:</b>
 * <ul>
 * <li><b>Red Flag Assessment:</b> Asks three critical questions (e.g., ability to speak, blue lips, chest retractions).</li>
 * <li><b>Emergency Logic:</b> If ANY red flag is present, immediately prompts to call 911 and sends a critical alert to the parent.</li>
 * <li><b>Home Care Routing:</b> If NO red flags are present, redirects the user to {@link SOSSecondaryActivity} for PEF checks and home steps.</li>
 * <li><b>Incident Logging:</b> Records the triage attempt and outcome to Firestore for history tracking.</li>
 * </ul>
 *
 * @author Zhan Tian
 * @version 1.0
