package com.example.smartair.ui.adapters;
 ...
 * <p>
 * RecyclerView Adapter responsible for displaying the list of medications in the Inventory (Requirement R3).
 * It visualizes the current stock status and alerts parents to issues directly in the list.
 * </p>
 * <b>Key Visual Logic:</b>
 * <ul>
 * <li><b>Data Binding:</b> Binds {@link MedicineItem} details (Name, Type, Remaining Dosage) to the UI.</li>
 * <li><b>Status Indicators:</b> Dynamically updates tags to show "Low" (<= 20%), "Empty", or "OK" statuses.</li>
 * <li><b>Expiration Warning:</b> highlights items that are "Expiring soon" to prompt replacement.</li>
 * <li><b>Replacement Logic:</b> Displays a specific "Buy replacement" warning text if inventory is critical.</li>
 * </ul>
 *
 * @author Zhan Tian
 * @version 1.0
