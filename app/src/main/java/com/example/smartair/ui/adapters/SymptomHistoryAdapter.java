...
/**
 * SymptomHistoryAdapter.java
 * <p>
 * RecyclerView Adapter responsible for binding symptom log data to the history list (Requirement R5).
 * Converts raw database records into a user-friendly, readable format.
 * </p>
 * <b>Key Visual Logic:</b>
 * <ul>
 * <li><b>Data Binding:</b> Maps {@link SymptomLog} fields (timestamp, author) to the view holder.</li>
 * <li><b>Symptom Formatting:</b> dynamically constructs a comma-separated string of active symptoms (e.g., "Night waking, Cough").</li>
 * <li><b>Trigger Display:</b> Formats the list of triggers into a readable string or displays "None recorded".</li>
 * </ul>
 *
 * @author Rphael Wang
 * @version 1.0
