 ...
 * <p>
 * Handles the recording of Peak Expiratory Flow (PEF) values (Requirement R4).
 * </p>
 * <b>Key Functionalities:</b>
 * <ul>
 * <li><b>Data Capture:</b> Collects PEF numerical values and optional tags (e.g., "Pre-medication").</li>
 * <li><b>Zone Calculation:</b> Automatically determines the Asthma Zone (Green, Yellow, Red) based on the child's Personal Best (PB).</li>
 * <li><b>Visual Feedback:</b> Updates the UI with color-coded zone indicators immediately after input.</li>
 * <li><b>Safety Alerts:</b> Triggers immediate alerts via {@link ParentAlertHelper} if the reading falls into the Red or Yellow zones.</li>
 * <li><b>Data Persistence:</b> Saves the log to the "pefLogs" Firestore collection for trending and analysis.</li>
 * </ul>
 *
 * @author Tan Ngo
 * @version 1.0
