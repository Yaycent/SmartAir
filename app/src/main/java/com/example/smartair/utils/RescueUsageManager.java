 ...
 * <p>
 * Background manager responsible for processing Rescue Medication usage events (Requirement R3 & R4).
 * It listens for new logs and performs inventory updates and safety checks.
 * </p>
 * <b>Key Functionalities:</b>
 * <ul>
 * <li><b>Automatic Inventory Deduction:</b> Listens for new "Rescue" logs and decrements the corresponding medication stock in real-time (R3).</li>
 * <li><b>Usage Tracking:</b> Updates statistics like "Last Rescue Time" and "Weekly Rescue Count" for the dashboard display.</li>
 * <li><b>Rapid Rescue Detection (R4):</b> Monitors usage frequency and triggers a parent alert if rescue meds are used ≥3 times in 3 hours.</li>
 * <li><b>Log Processing:</b> Marks logs as "processed" to prevent double-counting or duplicate alerts.</li>
 * </ul>
 *
 * @author Zhan Tian
 * @version 3.0
